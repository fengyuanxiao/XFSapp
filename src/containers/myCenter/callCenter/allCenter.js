        ...
        <div style={{ paddingTop: '3.7rem' }}>
          ...
          <Collapse accordion>
            ...
            <Panel header="淘宝号收货人信息要求" key="6">
              <p>绑定的信息（姓名、电话、地址）必须是真实的，电话地址有人接听签收；淘宝上使用的收货信息必须与小浣熊上绑定的收货信息相同；收货人姓名不真实、手机号码重复或收货地址不完整不能通过审核。收货地址要求村或小区不能重复，地址必须精确到几幢、几号，收货地址中不能出现附近、周围等字眼，不能精确到几幢的必须加上“电话联系”。
                </p>
            </Panel>
            ...
            <Panel header="刷单账号会被淘宝查封么" key="10">
              <p>用户必须按平台及商家的要求操作任务，且勿用一个淘宝号在多个平台同时刷单，如因不按要求操作导致账号被淘宝查封的用户小浣熊账号也将被查封并没收剩余佣金。</p>
            </Panel>
            <Panel header="什么是本金账户，本金提现要求" key="11">
              <p>个人中心的“本金总计”就是用户的本金账户，平台返款的任务商家确认后垫资直接返还到本金账户；</p>
              <p>本金提现每日一次，每次默认全额提出；500元及以上免服务费；500元以下收取1%服务费，新用户首次提现免费(推广期间全部免服务费)</p>
            </Panel>
            <Panel header="什么是佣金账户，佣金提现要求" key="12">
              <p>“佣金收益”就是佣金账户，用户提交任务评价截图后24小时佣金自动发放到佣金账户中；</p>
              <p>佣金提现返还到买手在小浣熊绑定的银行卡中，要求最低提现不低于10元</p>
            </Panel>
            <Panel header="什么时候返还本金" key="13">
            ...
            <Panel header="什么时候发佣金" key="14">
              <p>提交评价截图后商家确认了佣金直接到“佣金收益”中，如商家未及时确认，在提交后24小时系统自动发放。</p>
              <p>佣金提现返还到买手在小浣熊绑定的银行卡中，,且是50的倍数，提现50金需扣除手续费2金，提现100金起免手续费(推广期间全部免手续费，最低10元起提现)</p>
            </Panel>
          </Collapse>
        </div>
      </div>
